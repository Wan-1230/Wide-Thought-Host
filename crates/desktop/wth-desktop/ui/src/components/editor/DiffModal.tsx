    ...
    >
      ...
      >
        <div className="flex items-center gap-2 px-4 py-2.5 border-b flex-shrink-0" style={{ borderColor: "var(--surface-3)", background: "var(--surface-2)" }}>
          ...
          <span className="text-[10px] font-mono truncate min-w-0 hidden md:inline" style={{ color: "var(--text-dim)" }}>
            {diffModal.path}
          </span>
          ...
          <button onClick={closeDiff} className="p-1 rounded hover:bg-surface-3 flex-shrink-0" style={{ color: "var(--text-muted)" }} title="关闭">
            <X size={14} />
          </button>
        </div>

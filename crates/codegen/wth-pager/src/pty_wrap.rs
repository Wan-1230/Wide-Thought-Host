...
//! system clipboard. This is the engine behind `wth wrap` (see
...
///
/// This is the engine behind `wth wrap`: it spawns
...
pub(crate) fn run_wrapped_command(program: &str, args: &[String]) -> Result<i32> {
    ...
    // detached — `wth wrap` is short-lived and exits with the child.
